import { JiraUserStory } from './schemas'
...
export function buildPrompt(userStory: JiraUserStory, additionalInfo?: string): string {
  const { summary, description } = userStory.fields
